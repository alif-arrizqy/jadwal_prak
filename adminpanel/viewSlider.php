              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <a href="addSlider.php"><button type="button" class=" col-md btn btn-primary">Tambah Data</button></a>
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Caption</th>
                    ...
                    <?php
                      include 'koneksi.php';
                      $no = 1;
                      $data = mysqli_query($koneksi, "select*from tb_slider");
                      while ($d = mysqli_fetch_array($data)) {
                        ...
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo substr($capt, 0, $num_char) . '...'; ?></td>
                          <td><?php echo $d['gambar']; ?></td>
                          <td>
                            <a href="editSlider.php?id=<?php echo $d['id']; ?>">
                              <input type="submit" class="btn btn-info btn-xs" value="Edit">
                            </a>
                            <a href="hapusSlider.php?id=<?php echo $d['id']; ?>">
