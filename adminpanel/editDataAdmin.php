              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  ?>
                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post" action="updateDataAdmin.php" enctype="multipart/form-data">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> NPM <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" class="form-control col-md-7 col-xs-12" name="id" value="<?php echo $d['id']; ?>">
                          <input class="form-control col-md-7 col-xs-12" name="npm" type="text" value="<?php echo $d['npm']; ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Nama Lengkap <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" name="nama" type="text" value="<?php echo $d['nama']; ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Username <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" name="username" type="text" value="<?php echo $d['username']; ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          *harap isi password jika anda melakukan perubahan data
                        </div>
                      </div>
                      <div class="item form-group">
