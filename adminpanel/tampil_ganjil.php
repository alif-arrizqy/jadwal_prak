...
<h3>
    <center>Jadwal Praktikum Ganjil</center>
</h3>
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        include 'koneksi.php';
        $no = 1;
        $data = mysqli_query($koneksi, "select*from tb_jdwl_ganjil");
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="editJdwlGanjil.php?id_jdwl_ganjil=<?php echo $d['id_jdwl_ganjil']; ?>">
                        <input type="submit" class="btn btn-info btn-xs" value="Edit">
                    </a>
                    <a href="hapusJdwlGanjil.php?id_jdwl_ganjil=<?php echo $d['id_jdwl_ganjil']; ?>">
