...
<head>
    ...
    <title>Edit Jadwal Praktikum Genap</title>
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Edit Jadwal Praktikum Genap </h2>
                                ...
                                $data   = mysqli_query($koneksi, "SELECT * FROM tb_jdwl_genap WHERE id_jdwl_genap='$id'");
                                ...
                                ?>
                                <div class="x_content">
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="updateJdwlGenap.php">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control col-md-7 col-xs-12" name="id_jdwl_genap" value="<?php echo "$id"; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="matkul" id="matkul" class="form-control col-md-7 col-xs-12">
                                                    <?php
                                                    include 'koneksi.php';
                                                    $data = mysqli_query($koneksi, "select * from tb_matkul_genap where nama_matkul= '$matkul'");
