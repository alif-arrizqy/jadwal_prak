<?php
    ...
    // Proses ubah data ke Database
		$query = "UPDATE tb_jdwl_genap SET hari = '".$hari."', matkul = '".$matkul."', kelas = '".$kelas."', 
        asdos_1 = '".$asdos1."', asdos_2 =  '".$asdos2."', lab = '".$lab."', jam_mulai = '".$mulai."', 
        jam_selesai = '".$selesai."' WHERE id_jdwl_genap ='".$id."'";
		...
		//   header("location: viewData.php"); // Redirect ke halaman index.php
		  ...
		  window.location='editJdwlGenap.php';
		  </script>"; 
        }
